function [L,f] = fdassempde1d3pt(grd,pde)
%% CALL: [A,F] = fdassempde1d3pt(grd,pde);
% INPUT:
...
% DESCRIPTION:
% FDASSEMPDE1D3PT Berechnet den 3-Punkte-Stern
%    L = a/h^2 [-1 2 -1] + b/(2h) [-1 0 1] + c [0 1 0]
% und den Lastvektor f auf uniformen 1D Finite-Differenzen-Gittern.
% [A,F] = FDASSEMPDE1D3PT(GRD,OPR,PDE) gibt die Matrix A und den Vektor F der
...
% FDASSEMPDE1D3PT wird nicht direkt, sondern nur ueber FDASSEMPDE aufgerufen.
